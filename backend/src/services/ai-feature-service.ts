...
- "model": the FULL distinguishing model name. When multiple variants of the same product exist, include ALL key differentiators directly in the model name so each variant is uniquely identifiable. Include screen size, chip/processor, RAM, storage, display type (OLED/LCD/Mini-LED), and release year in parentheses where applicable. Examples: "MacBook Pro 14 M3 Pro 18GB (2023)", "ThinkPad X1 Carbon Gen 11 i7 16GB (2023)", "iPad Air 11 M2 256GB (2024)", "Galaxy S24 Ultra 12GB 256GB (2024)", "Envy x360 15 Ryzen 7 16GB OLED (2024)", "Surface Pro 10 i7 16GB (2024)". Do NOT give bare names like just "MacBook Pro" or "iPad" without distinguishing details.
