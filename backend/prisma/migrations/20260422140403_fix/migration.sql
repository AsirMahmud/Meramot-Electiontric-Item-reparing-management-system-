/*
  ...
  - You are about to drop the column `rejectedAt` on the `VendorApplication` table. All the data in the column will be lost.
  - You are about to drop the column `rejectionReason` on the `VendorApplication` table. All the data in the column will be lost.
  - You are about to drop the column `rejectionVisibleUntil` on the `VendorApplication` table. All the data in the column will be lost.
  - You are about to drop the column `userId` on the `VendorApplication` table. All the data in the column will be lost.
...
*/
-- CreateEnum
CREATE TYPE "DeliveryPartnerApprovalStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');
...
-- AlterEnum
ALTER TYPE "UserRole" ADD VALUE 'DELIVERY_ADMIN';
...
-- DropForeignKey
ALTER TABLE "VendorApplication" DROP CONSTRAINT "VendorApplication_userId_fkey";

-- DropIndex
DROP INDEX "VendorApplication_userId_key";
...
-- AlterTable
ALTER TABLE "VendorApplication" DROP COLUMN "rejectedAt",
DROP COLUMN "rejectionReason",
DROP COLUMN "rejectionVisibleUntil",
DROP COLUMN "userId",
...
CREATE TABLE "RiderProfile" (
    ...
    "isActive" BOOLEAN NOT NULL DEFAULT true,
    "registrationStatus" "DeliveryPartnerApprovalStatus" NOT NULL DEFAULT 'APPROVED',
...
-- CreateIndex
CREATE INDEX "RiderProfile_registrationStatus_idx" ON "RiderProfile"("registrationStatus");
