...
//   }
// }
router.get("/payments/:paymentId/invoice", requireAuth, async (req, res) => {
    try {
        ...
        const shop = payment.repairRequest?.requestedShop ??
        ...
        const approvedRefunds = payment.refunds.filter((r) => ["APPROVED", "PROCESSED"].includes(r.status));
