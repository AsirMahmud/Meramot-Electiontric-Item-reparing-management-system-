...
export async function approveDeliveryPartner(req, res) {
    try {
        ...
        if (updated.user.phone) {
            sendSms(updated.user.phone, `Your delivery partner registration is approved. Username: ${updated.user.username}, Password: ${generatedPassword}. Please change your password after login.`).catch((smsError) => {
