...
const isPusherConfigured = Boolean(env.pusherAppId && env.pusherKey && env.pusherSecret && env.pusherCluster);
...
export async function publishDeliveryChatMessage(deliveryId, payload) {
    if (!pusher)
        return;
