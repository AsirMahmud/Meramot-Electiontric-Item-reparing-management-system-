    ...
    <section className="space-y-10 pb-20">
      ...
      {loadingSummary ? (
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
          <div className="rounded-[28px] border border-[#D7E2D2] bg-[var(--box-bg)] p-6 shadow-sm transition hover:shadow-md">
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        <div className="xl:col-span-2 rounded-[32px] border border-[#D7E2D2] bg-[var(--box-bg)] p-8 shadow-sm">
        ...
        <div className="rounded-[32px] border border-[#D7E2D2] bg-[var(--box-bg)] p-8 shadow-sm">
      ...
      <div className="grid gap-6 xl:grid-cols-2">
        <form onSubmit={handleSettleSingle} className="rounded-[32px] border border-[#D7E2D2] bg-[var(--box-bg)] p-8 shadow-sm">
